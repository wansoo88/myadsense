...
- **배포**: 보유 Ubuntu `ssh -i ~/.ssh/autobtc_iwinv root@115.68.230.40`, **nginx+certbot**(80/443, data·itsmine 공유 — Caddy 아님), **서버 cron 24/7**. `stack.utilverse.info` **라이브**(실콘텐츠 15편 배포 2026-06-30, noindex 해제·색인 허용 — 2026-07-02 확인).
